(**
// can't yet format YamlFrontmatter (["title: Predicting Returns with text data"; "category: Scripts"; "categoryindex: 2"; "index: 4"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
